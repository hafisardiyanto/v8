...
Route::middleware('auth','log.activity')->group(function () {
    ...
    //route menambahkan cuti karyawan
    ...
    //route menambahkan shift karyawan
    ...
    //route menambahkan jabatan karyawan
    ...
    //Gaji Karyawan
    Route::get('/Gaji', [penggajianController::class, 'index'])->middleware('admin');
